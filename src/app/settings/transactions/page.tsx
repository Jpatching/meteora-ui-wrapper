...
import type { TransactionFilter, ProtocolType, TransactionStatus } from '@/types/transactions';
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-foreground-muted">
              View and manage your transaction history across all protocols
            </p>
          </div>
